...
def upgrade() -> None:
    ...
    op.add_column(
        "strategy_deployments", sa.Column("user_id", sa.UUID(), nullable=False)
    )
    op.create_foreign_key(
    ...
    op.add_column(
        "strategy_deployments", sa.Column("strategy_id", sa.UUID(), nullable=False)
    )
    op.create_foreign_key(
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "strategy_deployments_user_id_fkey", "strategy_deployments", type_="foreignkey"
    )
