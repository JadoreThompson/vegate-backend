...
# from .model import BacktestMetrics
...
# from module.strategy import StrategyConfig 
...
class BacktestConfig(StrategyConfig):
    ...
    def __init__(
        ...
        super().__init__(symbol, market_type, broker, timeframe)
...
class BacktestEngine:
    ...
    def run(self) -> BacktestMetricsSchema:
    ...
    def _calculate_metrics(self) -> BacktestMetricsSchema:
